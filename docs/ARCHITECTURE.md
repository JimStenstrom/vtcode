...
- **Tools**: `vtcode-core/src/tools/`, `vtcode-tools/` (ACP-only), MCP integration, slash commands, and the tool registry expose filesystem, search, edit, exec, and protocol-backed capabilities to the model.
