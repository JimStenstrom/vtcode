//! Default configuration templates for bootstrapping

/// Generate the default `vtcode.toml` template used by bootstrap helpers
#[cfg(feature = "bootstrap")]
pub fn default_vtcode_toml_template() -> String {
...
/// Generate default .gitignore for vtcode directories
#[cfg(feature = "bootstrap")]
pub fn default_vtcode_gitignore() -> String {
