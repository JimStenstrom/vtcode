//! Model identifier enum and related functionality

use super::{OpenRouterMetadata, Provider};
use crate::constants::models;
use serde::{Deserialize, Serialize};
use std::fmt;
use std::str::FromStr;

/// OpenRouter-generated metadata and parsing functions
#[cfg(not(docsrs))]
...
impl ModelId {
    ...
    pub(crate) fn openrouter_vendor_groups() -> Vec<(&'static str, &'static [Self])> {
        #[cfg(not(docsrs))]
        {
    ...
    pub(crate) fn openrouter_models() -> Vec<Self> {
...
impl FromStr for ModelId {
    type Err = super::ModelParseError;
        ...
        match s {
            ...
            _ => {
                if let Some(model) = Self::parse_openrouter_model(s) {
                    ...
                    Err(super::ModelParseError::InvalidModel(s.to_string()))
                }
            }
        }
    }
